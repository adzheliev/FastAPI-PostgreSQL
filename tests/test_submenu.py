...
class TestSubmenu:
    ...
    async def test_post_menu_for_submenus(
            self,
            ac: AsyncClient) -> None:
    ...
    async def test_empty_submenu_list(
            self,
            ac: AsyncClient) -> None:
    ...
    async def test_post_submenu_wit_same_parameters(
            self,
            ac: AsyncClient) -> None:
    ...
    async def test_number_of_submenus_in_menus_list_after_duplicate_post(
            self,
            ac: AsyncClient) -> None:
    ...
    async def test_specific_patched_submenu(
            self,
            ac: AsyncClient) -> None:
    ...
    async def test_patch_not_existing_submenu(
            self,
            ac: AsyncClient) -> None:
        ...
        response = await ac.patch(
            f"/api/v1/menus/{TestSubmenu.menu_id}/submenus/non_existing_submenu",
            json=data
        )
    ...
    async def test_delete_not_existing_submenu(
            self,
            ac: AsyncClient) -> None:
